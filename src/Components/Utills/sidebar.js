            ...
            <ul className="space-y-2">
                ...
                {isAlertOpen && (
                    <>
                     ...
                     <Link to="/FireDashBord">   <li className="hover:text-blue-600 py-1 px-4  "><LocalFireDepartmentIcon/>Fire </li></Link>
                    ...
                    <Link to="/AirAlerts">   <li className="hover:text-blue-600 py-1 px-4  "><AcUnitIcon/>Air quality</li></Link> 
                     <Link to="/WaterQuality"><li className="hover:text-blue-600 py-1 px-4 "><InvertColorsIcon/>Water quality</li></Link> 
                    </>
                )}
                ...
                {IslogOpen && (
                    <>
               <Link to="/AirQuality">  <li className="hover:text-blue-600 py-1 px-4 "><AcUnitIcon/>Air Quality</li> </Link>
                  <Link to="/EnergyMeter" >   <li className="hover:text-blue-600 py-1 px-4  "><EnergySavingsLeafIcon/>Energy Meter </li></Link>
                <Link to="/WaterMeter">   <li className="hover:text-blue-600 py-1 px-4  "><OpacityIcon/>Water Meter </li></Link>  
                  <Link to="/LevelMeter"> <li className="hover:text-blue-600 py-1 px-4  "><Brightness1Icon/>Level Meter </li></Link>
